...
class ActionSimulator():
    ...
    def _simulate_user_input(
        ...
        if not need_images and not need_featurized_objects:
            stride = 100000
        is_solved, had_occlusions, images, objects, relationships, images_ids = phyre.simulator.magic_ponies(
            serialzed_task,
            user_input,
            stride=stride,
            keep_space_around_bodies=self._keep_spaces,
        ...
        return status, images, objects, relationships, images_ids
    ...
    def simulate_action(self,
        ...
        main_status, images, objects, relationships, images_ids = self._simulate_user_input(
        ...
        for modified_user_input in _yield_user_input_neighborhood(user_input):
            status, _, _, relationships, images_ids = self._simulate_user_input(
                task_index,
                modified_user_input,
                need_images=False,
                need_featurized_objects=False,
